<form role="form" enctype="multipart/form-data" action="savenews.php" method="post">
  ...
  <div class="form-group">
    <label for="date">Insérez la date de l'ajout:</label>
    <input type="text" class="form-control" id="datenews" name="datenews">
  
  </div>
  
    <div class="form-group">
    <label for="texte">Insérez votre texte:</label>
<textarea class="form-control" rows="10" name="texte"></textarea>
